...
import { Facebook, Youtube, Gamepad2, Mail, Phone, MapPin } from "lucide-react";
            ...
            <div className="max-w-7xl mx-auto px-4 md:px-8 pt-16 pb-8">
                ...
                <div className="mb-12 pb-8 border-b border-gray-800">
                    <div className="flex items-center gap-3 mb-4">
                        <div className="bg-gradient-to-br from-blue-500 to-blue-600 text-white p-2.5 rounded-lg shadow-lg">
                            <Gamepad2 size={28} />
                        </div>
                        <div>
                    ...
                    <div>
                        ...
                        <div className="flex gap-3 mb-6">
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="w-10 h-10 rounded-lg bg-gradient-to-br from-blue-600 to-blue-700 flex items-center justify-center hover:scale-110 transition-transform duration-200 shadow-lg"
                            >
                            ...
                            <a
                                ...
                                target="_blank"
                                rel="noreferrer"
                                className="w-10 h-10 rounded-lg bg-gradient-to-br from-red-600 to-red-700 flex items-center justify-center hover:scale-110 transition-transform duration-200 shadow-lg"
                            >
                                <Youtube size={18} fill="currentColor" />
                            </a>
                        </div>

                        <div className="text-xs text-gray-500 mb-2">Phương thức thanh toán</div>
                        <div className="flex flex-wrap gap-2">
                            <div className="bg-white rounded p-1.5 hover:scale-105 transition-transform">
                                <img src="https://cdn.haitrieu.com/wp-content/uploads/2022/10/Logo-MoMo-Transparent.png" alt="MoMo" className="h-5 w-auto" />
                            </div>
                            <div className="bg-white rounded p-1.5 hover:scale-105 transition-transform">
                                <img src="https://pay.vnpay.vn/images/bank/qr-vnpayewallet.png" alt="VNPay" className="h-5 w-auto" />
                            </div>
                            <div className="bg-white rounded p-1.5 hover:scale-105 transition-transform">
                                <img src="https://upload.wikimedia.org/wikipedia/commons/thumb/5/5e/Visa_Inc._logo.svg/2560px-Visa_Inc._logo.svg.png" alt="Visa" className="h-4 w-auto mt-0.5" />
                            </div>
                            <div className="bg-white rounded p-1.5 hover:scale-105 transition-transform">
