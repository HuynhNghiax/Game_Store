                ...
                <div className="container mx-auto px-4 pt-20 pb-16 relative z-10">
                    ...
                    GAME BẢN QUYỀN
                        ...
                        <p className="text-gray-400 text-base md:text-lg max-w-2xl mx-auto leading-relaxed">
                            Nơi cập nhật những chuyển động mới nhất của làng game thế giới.
                            Đồng hành cùng game thủ trong việc lựa chọn <span className="text-blue-400">trải nghiệm nguyên bản</span>,
                            an toàn và <span className="text-white font-medium">trân trọng giá trị chất xám</span> của nhà phát triển.
                        </p>
            ...
            <div className="container mx-auto px-4 pb-20 relative z-10">
                                ...
                                <div className="relative bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] border border-gray-800 group-hover:border-gray-700 transition-all rounded-3xl overflow-hidden">
                                    <div className="grid lg:grid-cols-2 gap-0">
                                        ...
                                        <div className="p-8 lg:p-12 flex flex-col justify-center">
                                            <div className="mb-4">
                                                <span className="inline-block px-3 py-1 bg-blue-500/10 border border-blue-500/30 text-blue-400 text-xs font-bold uppercase tracking-wider rounded-lg">
                                                    Nổi bật
                                                </span>
                                            </div>
                                            ...
                                            <p className="text-gray-400 text-base lg:text-lg mb-6 leading-relaxed line-clamp-3">
                                            ...
                                            <div className="inline-flex items-center gap-3 px-6 py-3 bg-gradient-to-r from-blue-500 to-purple-500 text-white font-bold rounded-xl group-hover:gap-5 group-hover:shadow-2xl group-hover:shadow-blue-500/50 transition-all">
                ...
                {regularBlogs.length > 0 && (
                    <>
                        <div className="flex items-center justify-between mb-8">
                            ...
                            <span className="px-4 py-2 bg-white/5 border border-gray-800 rounded-xl text-gray-400 font-semibold">
                            ...
                            {regularBlogs.map((blog) => (
                                ...
                                >
                                    <div className="relative h-full bg-gradient-to-br from-[#0f0f0f] to-[#1a1a1a] rounded-2xl overflow-hidden border border-gray-800 hover:border-gray-700 transition-all duration-300 hover:-translate-y-2">
                                        <div className="absolute inset-0 bg-gradient-to-br from-blue-500/0 to-purple-500/0 group-hover:from-blue-500/10 group-hover:to-purple-500/10 transition duration-500"></div>
                                        ...
                                        <div className="relative h-56 overflow-hidden">
                                            ...
                                            <span className="absolute top-4 right-4 px-3 py-1.5 bg-black/80 backdrop-blur-sm border border-blue-500/50 text-blue-400 text-xs font-bold uppercase rounded-lg">
                                                {blog.category}
                                            </span>
                                        </div>
                                        ...
                                        <div className="relative p-6">
                                            ...
                                            <h3 className="text-xl font-bold text-white mb-3 leading-tight line-clamp-2 group-hover:text-transparent group-hover:bg-clip-text group-hover:bg-gradient-to-r group-hover:from-blue-400 group-hover:to-purple-400 transition-all">
                                                {blog.title}
                                            </h3>
                ...
                {filteredBlogs.length === 0 && (
                    <div className="text-center py-20">
                        ...
                        <p className="text-gray-500 text-xl mb-2">Không tìm thấy bài viết nào</p>
